...
public class Part2 {
    ...
    public static void main(String[] args) {
        try {
            ...
            List<Part1.Board> boardList = new ArrayList<>();
            Part1.Board board = null;
            int gridLine = 0;
            ...
            List<Integer> winBoardList = new ArrayList<>();

            for (int i = 0; i < drawingNumberList.size(); i++) {
                for (int j = 0; j < boardList.size(); j++) {
                    if (!winBoardList.contains(j)){
            ...
            System.out.println("The second response is : " + (winNumber * boardList.get(winGridNumber).score(drawingNumberList.subList(0, drawingNumberList.indexOf(winNumber) + 1))));
